...
public class BoxManagementApplication implements CommandLineRunner {
	...
	public void run(String... args) {
		...
		deliveryIDs.add("deliveryID1");

		boxes.add(new Box("targetBox1", address1, BoxStatus.available, deliveryIDs, null));
		//boxes.add(new Box(null, address1, BoxStatus.available, "deliveryID2", null));
		//boxes.add(new Box(null, address2, BoxStatus.occupied, "deliveryID3", null));
		//boxes.add(new Box(null, address2, BoxStatus.occupied, "deliveryID4", null));
		//boxes.add(new Box(null, address3, BoxStatus.occupied, "deliveryID5", null));
